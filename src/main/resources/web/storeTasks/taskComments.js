...
//   storeTaskComments()      — renders the read-only comment list (CUSTOM 'storeTaskComments')
//   storeTaskCommentEditor() — the Quill + @mention editor in the edit dialog (CUSTOM 'storeTaskCommentEditor')

function storeTaskComments() {
...
// ----------------------------------------------------------------------------
function storeTaskCommentEditor() {
